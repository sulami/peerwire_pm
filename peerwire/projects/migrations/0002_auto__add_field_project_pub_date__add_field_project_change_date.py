...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.pub_date'
        db.add_column(u'projects_project', 'pub_date',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2014, 4, 10, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Project.change_date'
        db.add_column(u'projects_project', 'change_date',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, default=datetime.datetime(2014, 4, 10, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.pub_date'
        db.delete_column(u'projects_project', 'pub_date')

        # Deleting field 'Project.change_date'
        db.delete_column(u'projects_project', 'change_date')
