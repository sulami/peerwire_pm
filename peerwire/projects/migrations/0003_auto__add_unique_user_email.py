...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique(u'projects_user', ['email'])

        # Adding M2M table for field del_q on 'Project'
        m2m_table_name = db.shorten_name(u'projects_project_del_q')
    ...
    def backwards(self, orm):
        ...
        db.delete_unique(u'projects_user', ['email'])

        # Removing M2M table for field del_q on 'Project'
        db.delete_table(db.shorten_name(u'projects_project_del_q'))
